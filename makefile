...
AVRLIB_CONF_PATH = ../../libs/avrlib/conf
...
EXTRAINCDIRS = $(LUFA_PATH)/  $(AVRLIB_PATH)/ $(AVRLIB_CONF_PATH)
...
dfu-u4: $(TARGET).hex
	...
	dfu-programmer atmega32u4 flash --debug 1 $(TARGET).hex
